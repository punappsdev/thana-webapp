        ...
        {slides.map((slide, idx) => (
          ...
          >
            ...
            <div className="relative z-10 h-full flex flex-col justify-center px-4 md:px-10 max-w-[1280px] mx-auto text-white">
              <span className="text-xs bg-[#3ca6fe]/20 backdrop-blur-md px-4 py-2 rounded-full w-fit mb-6 font-medium tracking-wide">
                {slide.tag}
              </span>
              <h1 className="font-heading text-4xl md:text-5xl font-semibold max-w-2xl mb-6 leading-tight">
                {slide.title}
              </h1>
              <p className="font-sans text-base md:text-lg max-w-xl mb-8 opacity-90 leading-relaxed">
                {slide.desc}
              </p>
