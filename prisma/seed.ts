  ...
  const categoryData = [
    {
      ...
      sortOrder: 1,
      subs: [
        { slug: "standard-board", nameTh: "แผ่นยิปซัม", nameEn: "Gypsum Board" },
        { slug: "ceiling-tbar", nameTh: "แผ่นฝ้าทีบาร์", nameEn: "T-Bar Ceiling System" },
        { slug: "ceiling-access-panel", nameTh: "ช่องเซอร์วิส", nameEn: "Ceiling Access Panel" },
        { slug: "gypsum-plaster", nameTh: "ปูนฉาบยิปซัม", nameEn: "Gypsum Plaster" },
        { slug: "ceiling-frame", nameTh: "โครงราว และอุปกรณ์", nameEn: "Ceiling Framing" },
    ...
    },
    {
      ...
      subs: [
        ...
        { slug: "smartboard", nameTh: "สมาร์ทบอร์ด", nameEn: "Smartboard" },
        { slug: "shera-board", nameTh: "เฌอร่าบอร์ด", nameEn: "Shera Board" },
      ],
    },
    {
      slug: "glass",
      ...
      subs: [
        ...
        { slug: "insulated", nameTh: "กระจกอินซูเลท", nameEn: "Insulated Glass" },
        ...
        { slug: "glass", nameTh: "กระจกทั่วไป", nameEn: "Glass" },
        { slug: "decorate-glass", nameTh: "กระจกตกแต่ง", nameEn: "Decorate Glass" },
        { slug: "annealed-glass", nameTh: "กระจกแปรรูป (AN)", nameEn: "Annealed Glass" },
      ],
    },
    {
      slug: "aluminum",
      ...
      subs: [
        ...
        { slug: "aluminum-swing-set", nameTh: "ชุดบานสวิง", nameEn: "Swing Door Set" },
        { slug: "aluminum-sliding-set", nameTh: "ชุดบานเลื่อน", nameEn: "Sliding Door Set" },
        { slug: "aluminum-awning-set", nameTh: "ชุดบานกระทุ้ง", nameEn: "Awning Window Set" },
        { slug: "screen-mesh-set", nameTh: "ชุดมุ้งลวด", nameEn: "Screen Mesh Set" },
        { slug: "adjustable-glass-louver-set", nameTh: "ชุดบานเกร็ดบังแดด", nameEn: "Glass Louver Set" },
        { slug: "aluminum-l-angle", nameTh: "ชุดฉาก", nameEn: "L-Angle Set" },
        { slug: "aluminum-box-set", nameTh: "ชุดกล่อง", nameEn: "Box Profile Set" },
        { slug: "aluminum-round-tube-corrugated-set", nameTh: "ชุดท่อกลมและชุดลูกฟูก", nameEn: "Round Tube & Corrugated Set" },
        { slug: "curtain-track-triple-track-frame-set", nameTh: "ชุดรางม่านและเฟรม 3 ราง", nameEn: "Curtain Track & Triple-Track Frame Set" },
        { slug: "aluminum-sliding-set-3-inch", nameTh: "ชุดบานเลื่อน (3 นิ้ว)", nameEn: "Sliding Window Set (3 inch)" },
        { slug: "other-aluminum-hardware", nameTh: "อุปกรณ์อื่นๆ", nameEn: "Other Accessories" },
      ],
    },
    {
      ...
      sortOrder: 5,
      subs: [
        { slug: "handles", nameTh: "อุปกรณ์ติดตั้ง", nameEn: "Installation Tools" },
        { slug: "hinges", nameTh: "บานพับและอุปกรณ์ยึด", nameEn: "Hinges & Fittings" },
        { slug: "sealant", nameTh: "กาวและเคมีภัณฑ์", nameEn: "Sealants & Adhesives" },
